...
public class CombatRanged implements CombatAttack {
    private String targetLabel;
    private String weaponName;
    private Integer nbrRoundsAimed;
    ...
    public Integer getNbrRoundsAimed() {
        return nbrRoundsAimed;
    }

    public void setNbrRoundsAimed(Integer nbrRoundsAimed) {
        this.nbrRoundsAimed = nbrRoundsAimed;
    }
