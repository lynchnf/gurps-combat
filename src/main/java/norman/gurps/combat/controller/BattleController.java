...
public class BattleController {
    ...
    public CombatResponse addStoredCharacterToCurrentBattle(AddStoredCharacterToCurrentBattleRequest req) {
    ...
    public CombatResponse removeCombatantFromCurrentBattle(RemoveCombatantFromCurrentBattle req) {
